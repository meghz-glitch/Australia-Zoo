...
export const animals = [
    ...
    name: 'Echidna',image: new URL("/src/assets/echinda.jpg", import.meta.url).href,
      lifespan: '50 years',
      group: 'mammals',
      food: 'insects such as ants and termites, beetle larvae and worms',
      description: 'Echidnas, also called spiny anteaters, are walking contradictions. They are mammals, but they lay eggs. They are often classified as long- or sort-beaked, but donot have beaks at all, in the traditional sense; they have fleshy noses that can be either on the long side or rather short. They donot really look like true anteaters (Myrmecophaga tridactyla), either, and they are not closely related to them. They are spiny, though; their bodies are covered with hollow, barbless quills. Echidnas are monotremes, egg-laying mammals. The only other living monotreme is the platypus.',
      length: '76cm',
      weight: '10kg',
